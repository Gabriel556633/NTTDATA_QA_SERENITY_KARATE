...
public class TaskDoSelectProduct2 implements Task {


    public TaskDoSelectProduct2() {
    ...
    public static Performable selectProduct (){
        ...
        return  instrumented(TaskDoSelectProduct2.class);//     SERENITY PARA INFORME
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        try{
                actor.attemptsTo(
                        ...
                        Click.on(SelectProduct.PRODUCT2)
                );
        }catch (Exception e){
            return;
        }
